...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    /**
     * Create a defaults view to be used for tabs. This is called if a custom tab view is not set via
    ...
    public void changeTabViewTextColor(int colorSource,int alpha){
        for(int i = 0 ;i < mTabStrip.getChildCount(); i++){
            View tabView = mTabStrip.getChildAt(i);
            TextView textView = (TextView)tabView.findViewById(mTabViewTextViewId) ;
            textView.setTextColor(getResources().getColorStateList(colorSource));
            textView.setSelected(i == mViewPager.getCurrentItem());
            int currentTextColor = textView.getCurrentTextColor();
            textView.setTextColor(Color.argb(alpha, Color.red(currentTextColor), Color.green(currentTextColor), Color.blue(currentTextColor)));
        }
    }
