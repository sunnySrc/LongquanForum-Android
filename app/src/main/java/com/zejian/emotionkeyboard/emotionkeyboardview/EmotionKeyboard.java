...
public class EmotionKeyboard {
    ...
    private void updatePanel(int pos) {
        if (mEmotionLayout.isShown()) {
            ...
            if (isSoftInputShown()) {//同上
                ...
                showEmotionLayout(pos);//两者都没显示，直接显示表情布局
            }
        }
    }
    ...
    private void hideEmotionLayout(boolean showSoftInput) {
        if (mEmotionLayout.isShown()) {
//            mEmotionLayout.startAnimation(AnimationUtils.loadAnimation(mActivity, R.anim.fade_out_fast));
...
//	        }
    ...
    /**
     * {@link }https://github.com/driftyco/ionic-plugin-keyboard/issues/160
     * @param activity
     * @return
     */
