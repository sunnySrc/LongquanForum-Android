 ...
 */
public class Discuz2Fragment extends BaseRefreshFragment {
    ...
    protected void onExecuteRequest(HttpResponseHandler handler) {
        page = 1;
        request = LqForumApi.topicList(page, "new", "0", this);
    }
    ...
    public void onLoadMore() {
        LqForumApi.topicList(++page, "new", "0", new HttpResponseHandler() {
            @Override
