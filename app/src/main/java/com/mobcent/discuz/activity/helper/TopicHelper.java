...
//                            UIJumper.to(context, item.getInfor());
    ...
    /*
     * @deprecated 更新内容闪烁 ，使用LinearLayout 替换
     */
//    public static class ContentAdapter extends ComAdapter<TopicContent> {
//
//        public ContentAdapter(Context context, List<TopicContent> objects) {
//            super(context, R.layout.topic_detail1_middle_item, objects);
//        }
//
//        @Override
//        public void customSet(ViewHolder holder, final TopicContent item, int position) {
//            // 设置可见性
//            setVisible(holder, item);
//
