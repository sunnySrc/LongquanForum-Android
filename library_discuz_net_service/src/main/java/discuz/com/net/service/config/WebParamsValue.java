package discuz.com.net.service.config;
...
public class WebParamsValue {
    ...
    public static final String egnVersions = "v2035.2";
    public static final String appNames = "龙泉论坛";
    public static final String sdkTypes = "";
    public static final String packageNames = "com.appbyme.app178470";
    public static final String forumKeys = "BW0L5ISVRsOTVLCTJx";
