...
public interface UserInfoService {
    ...
    Observable<MessageResult> requestMessage(@FieldMap Map<String, String> params);

    /*获取我的评论*/
    @FormUrlEncoded
    @POST("index.php?r=message/notifylistex")
    Observable<CommentResult> requestComment(@FieldMap HashMap<String, String> my_comment_map);

    /*获取系统消息*/
    @FormUrlEncoded
    @POST("index.php?r=message/notifylistex")
    Observable<SystemResult> requestSystem(@FieldMap HashMap<String, String> my_comment_map);
